...
urlpatterns = patterns('musicdb.classical.views',
    ...
    url(r'^timeline/$', 'timeline',
        name='classical-timeline'),
    url(r'^timeline/data$', 'timeline_data',
        name='classical-timeline-data'),

    url(r'^artist/timeline/(?P<slug>[^/]+)$', 'artist_timeline',
        name='classical-artist-timeline'),
    url(r'^artist/timeline/(?P<slug>[^/]+)/data$', 'artist_timeline_data',
        name='classical-artist-timeline-data'),
